...
#include <sensor_msgs/msg/point_field.hpp>
    ...
    #define MS_DRIVER_POINT_FIELD_LIST_TIMESTAMP                     \
        sensor_msgs::msg::PointField{}                               \
            ...
            .set__count(1)                                           \
            .set__offset(                                            \
                4 * COMPUTE_NUM_CONTIGUOUS_POINT_FIELDS(             \
                        MS_DRIVER_POINT_TYPE_FIELDS)),               \
            sensor_msgs::msg::PointField{}                           \
                .set__name("th")                                     \
                .set__datatype(sensor_msgs::msg::PointField::UINT32) \
                .set__count(1)                                       \
        ...
        sensor_msgs::msg::PointField{}                                      \
            ...
            .set__offset(                                                   \
                (4 * COMPUTE_NUM_CONTIGUOUS_POINT_FIELDS(                   \
                         MS_DRIVER_POINT_TYPE_FIELDS)) +                    \
                (8 *                                                        \
                 POINT_FIELDS_HAVE_TIMESTAMP(MS_DRIVER_POINT_TYPE_FIELDS)))
#else
    #define MS_DRIVER_POINT_FIELD_LIST_REFLECTOR
#endif
...
#define MS_DRIVER_POINT_FIELD_LIST                                         \
    {sensor_msgs::msg::PointField{}                                        \
     ...
     sensor_msgs::msg::PointField{}                                        \
         ...
         .set__count(1)                                                    \
         .set__offset(8),                                                  \
     MS_DRIVER_POINT_FIELD_LIST_INTENSITY MS_DRIVER_POINT_FIELD_LIST_RANGE \
